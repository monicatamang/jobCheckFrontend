                ...
                <v-container>
                    <v-row>
                        ...
                        <!-- <v-col cols="12">
                            <v-row>
                                <v-col cols="4">
                                    <v-text-field v-model="addInterviewData.interviewTime" label="Time*" hint="HH:MM" :color="primaryColor"></v-text-field>
                                </v-col>
                                <v-col cols="4">
                                    <v-select v-model="addInterviewData.interviewTimePeriod" label="Period*" :items="timePeriod" :color="primaryColor"></v-select>
                                </v-col>
                                <v-col cols="4">
                                    <v-text-field v-model="addInterviewData.interviewTimeZone" label="Time Zone*" :color="primaryColor"></v-text-field>
                                </v-col>
                            </v-row>
                        </v-col> -->
                        <v-col cols="12">
